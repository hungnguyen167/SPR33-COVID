...
m51 <- boot(data = df, statistic = m_coef, R = 1000, formula = behave ~ gap1a)
 
m52 <- boot(data = df, statistic = m_coef, R = 1000, formula = behave  ~  gap1a + chi2) 

m53 <-  boot(data = df, statistic = m_coef, R = 1000, formula = behave  ~ gap1a + chi2 + dpm2)

m54 <-  boot(data = df, statistic = m_coef, R = 1000, formula =behave  ~ gap1a + chi2 + dpm2 + gini_disp)

m55 <-  boot(data = df, statistic = m_coef, R = 1000, formula = behave ~ gap1a + chi2 + dpm2 + gini_disp + soc_spend)

m56 <-  boot(data = df, statistic = m_coef, R = 1000, formula = behave ~ gap1a + chi2 + dpm2 + gini_disp + soc_spend  + gdp)
